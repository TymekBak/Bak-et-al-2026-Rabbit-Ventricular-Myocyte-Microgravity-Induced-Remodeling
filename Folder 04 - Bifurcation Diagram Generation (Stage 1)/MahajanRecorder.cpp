...
int main(int argc, char *argv[]) {
    ...
    //Loop Through PCL Values of 400ms to 200ms. Note that PCL and BCL are equivalent.
    double PCL = 400;
    ...
    while(PCL >= 200){
        ...
        double stim = 0;
        int n = 0;
        int n_total = ceil(2000000/PCL);
        if(PCL < 300){
            n_total = ceil(4000000/PCL);
        }
        ...
        //Transition to the analysis of the next APD.
        PCL = PCL - 10;
        std::cout << "PCL: " << PCL << "\n";
    }
}
