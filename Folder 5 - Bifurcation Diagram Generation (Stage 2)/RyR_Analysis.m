...
Baseline_Perturbation = "Outcomes_n/Baseline_V1.txt";
Baseline_Perturbation = readmatrix(Baseline_Perturbation);
Baseline_PerturbationThreshold = readmatrix("AlternansThresholdGuess/Baseline_V1.txt");

Microgravity_Perturbation = "Outcomes_n/Manuscript_V1.txt";
Microgravity_Perturbation = readmatrix(Microgravity_Perturbation);
Microgravity_PerturbationThreshold = readmatrix("AlternansThresholdGuess/Manuscript_V1.txt");
...
Baseline_Perturbation = "Outcomes_t/Baseline_V1.txt";
Baseline_Perturbation = readmatrix(Baseline_Perturbation);
Baseline_Perturbation = Baseline_Perturbation((Baseline_Perturbation(:,1) == 400),:);

Microgravity_Perturbation = "Outcomes_t/Manuscript_V1.txt";
Microgravity_Perturbation = readmatrix(Microgravity_Perturbation);
