...
load VoltageAlternansSensitivityAnalysis3.mat
...
output_names = {'Voltage Alternans Threshold'};
...
xline((Thresholds(1)), "Label","Baseline","LabelHorizontalAlignment","left","FontSize",20,"FontWeight","bold")
a.set("FaceAlpha",0.5);
a.set("BinWidth",(max(Thresholds(2:end)) - min(Thresholds(2:end)))/20);
title("AP Alternans Threshold BCL (ms)")
ylim([0,250])
set(gca,"FontSize",20)
