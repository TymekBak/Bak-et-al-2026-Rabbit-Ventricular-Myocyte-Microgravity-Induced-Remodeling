...
figure(1)
clf
plot(BCLs1,APD1,"Color","blue","LineStyle","-","LineWidth",3)
hold on
plot(BCLs2,APD2,"Color","red","LineStyle","-","LineWidth",3)
xlabel("BCL (ms)")
ylabel("APD (ms)")
xlim([200,400])
set(gca,"FontSize",16)
xline(250,"LineWidth",3,"LineStyle","--","Color","Black")

figure(2)
clf
plot(BCLs1,CaT1,"Color","blue","LineStyle","-","LineWidth",3)
hold on
plot(BCLs2,CaT2,"Color","red","LineStyle","-","LineWidth",3)
xlabel("BCL (ms)")
