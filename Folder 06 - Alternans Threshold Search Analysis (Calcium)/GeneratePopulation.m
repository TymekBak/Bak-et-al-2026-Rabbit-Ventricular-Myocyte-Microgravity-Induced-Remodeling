...
for i = 0:1000
    ...
    ThresholdFileName = "AlternansThresholds/Baseline_P" + i + ".txt";
    ...
    CommandLineSegement = "./MahajanRecorder " + IndividualFileName + " " + ConvergenceFileName + " " + TimeCourseFileName + " " + ThresholdFileName;
