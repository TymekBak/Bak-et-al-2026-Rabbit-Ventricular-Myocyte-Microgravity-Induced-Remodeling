...
for n = 1:length(directory)
    ...
    if(endsWith(file(10:13),"."))
        saveas(CaT,("Bifurcation Diagrams/CaT " + file(10:12) + ".png"))
        saveas(APD,("Bifurcation Diagrams/APD " + file(10:12) + ".png"))
        saveas(Both,("Bifurcation Diagrams/Both " + file(10:12) + ".png"))
    else
    ...
    %% Extract the timecourse data and use it describe the model behavior before and after the onset of action potential and Ca^{2+} Alternans.
