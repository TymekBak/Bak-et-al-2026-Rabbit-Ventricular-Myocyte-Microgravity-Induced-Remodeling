...
ILTCC1_threshold = (max(ILTCC1_segment) - min(ILTCC1_segment))*exp(-1) + min(ILTCC1_segment);
ILTCC2_threshold = (max(ILTCC2_segment) - min(ILTCC2_segment))*exp(-1) + min(ILTCC2_segment);
