...
ILTCC1_threshold = (max(ILTCC1_segment) - min(ILTCC1_segment))*0.5 + min(ILTCC1_segment);
ILTCC2_threshold = (max(ILTCC2_segment) - min(ILTCC2_segment))*0.5 + min(ILTCC2_segment);
