...
•	**CalciumTransientAnalysisFollowUp.py:** This file is used to visually inspect the individuals that failed in the simulation from this folder. This omits the six individuals that were missed due to a typo and at least part of the individuals which were already analyzed in *Folder 6*.\
